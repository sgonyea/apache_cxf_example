...
public class PrivateLabel {
    ...
    @XmlElement(name = "ID", namespace = "http://exacttarget.com/wsdl/partnerAPI", required = true, type = Integer.class, nillable = true)
    protected Integer id;
    @XmlElement(name = "Name", namespace = "http://exacttarget.com/wsdl/partnerAPI", required = true)
    protected String name;
    @XmlElement(name = "ColorPaletteXML", namespace = "http://exacttarget.com/wsdl/partnerAPI")
    protected String colorPaletteXML;
    @XmlElement(name = "LogoFile", namespace = "http://exacttarget.com/wsdl/partnerAPI")
    protected String logoFile;
    @XmlElement(name = "Delete", namespace = "http://exacttarget.com/wsdl/partnerAPI")
    protected int delete;
    @XmlElement(name = "SetActive", namespace = "http://exacttarget.com/wsdl/partnerAPI")
