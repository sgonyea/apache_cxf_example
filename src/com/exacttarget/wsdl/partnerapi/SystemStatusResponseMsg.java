...
import com.exacttarget.wsdl.partnerapi.SystemStatusResponseMsg.Results;


/**
 * <p>Java class for SystemStatusResponseMsg element declaration.
 * 
...
public class SystemStatusResponseMsg {
    ...
    @XmlElement(name = "RequestID", namespace = "http://exacttarget.com/wsdl/partnerAPI", required = true)
