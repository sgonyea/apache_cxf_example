...
public class RetrieveRequest {
    ...
    @XmlElement(name = "RepeatLastResult", namespace = "http://exacttarget.com/wsdl/partnerAPI")
    protected Boolean repeatLastResult;
    @XmlElement(name = "Retrieves", namespace = "http://exacttarget.com/wsdl/partnerAPI")
     ...
     *     
     */
    public void setRetrieves(Retrieves value) {
    ...
    public static class Retrieves {
        ...
        @XmlElement(name = "Request", namespace = "http://exacttarget.com/wsdl/partnerAPI", required = true)
