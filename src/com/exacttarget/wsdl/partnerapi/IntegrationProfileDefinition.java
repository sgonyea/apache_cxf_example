    ...
    extends APIObject
{
    ...
    @XmlElement(name = "Description", namespace = "http://exacttarget.com/wsdl/partnerAPI", required = true)
    protected String description;
    @XmlElement(name = "ExternalSystemType", namespace = "http://exacttarget.com/wsdl/partnerAPI")
